...
SECRET_KEY = 'django-insecure-4+(jm((ma0#12+!3l^(4@1115&8n3b=-zi+-44b6vm7z6&f!h)'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # You can add global templates directory if needed
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / 'static']  # Adjust based on your project structure
